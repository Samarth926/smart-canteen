...
<!-- Main Content Start -->
    ...
    <tr>
      ...
      <td width="290"><div align="center"><strong>Dish Status</strong></div></td>
...
%>
    ...
    <%
ResultSet res=i.stm.executeQuery("select * from dish_details");
int a=0;
while(res.next())
{
  a++;
...
%>
    <tr>
      ...
      <td><div align="center"><%=res.getString("d_status")%></div></td>

      <td><div align="center"><strong><a class="btn btn-primary btn-sm" href="dish_edit.jsp?id=<%=id%>">Edit</a> <a onclick="return confirm('Are You Sure?..')" class="btn btn-danger btn-sm" href="dish_delete.jsp?id=<%=id%>">Delete</a></div></td>
    </tr>
    <%
	}
	%>
